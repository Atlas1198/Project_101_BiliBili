...
public:
	EffectBase(
		...
		DirectX::XMFLOAT2 size = DirectX::XMFLOAT2(1.0f, 1.0f),					//サイズ
	...
	DirectX::XMFLOAT2 GetSize() const { return m_size; }		//サイズ取得
	...
	void SetSize(DirectX::XMFLOAT2 size) { m_size = size; }			//サイズ設定
