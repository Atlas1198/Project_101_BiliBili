...
void Controller::UpdateTriggerState(ControllerState& cs, ControllerInputInfo& inputInfo)
{
	...
	//どのキーでも(まだテストしない)
	inputInfo.any.trigger = 
		inputInfo.A.trigger ||
		inputInfo.B.trigger ||
		inputInfo.X.trigger ||
		inputInfo.Y.trigger ||
		inputInfo.START.trigger ||
		inputInfo.BACK.trigger ||
		inputInfo.LSHOULDER.trigger ||
		inputInfo.RSHOULDER.trigger ||
		inputInfo.LTHUMB.trigger ||
		inputInfo.RTHUMB.trigger ||
		inputInfo.UP.trigger ||
		inputInfo.DOWN.trigger ||
		inputInfo.LEFT.trigger ||
		inputInfo.RIGHT.trigger;
...
void Controller::UpdateDownState(ControllerState& contState, ControllerInputInfo& inputInfo)
{
	...
	inputInfo.any.down = 
		...
		inputInfo.X.down ||
		inputInfo.Y.down ||
		inputInfo.START.down ||
		inputInfo.BACK.down ||
		inputInfo.LSHOULDER.down ||
		inputInfo.RSHOULDER.down ||
		inputInfo.LTHUMB.down ||
		inputInfo.RTHUMB.down ||
		inputInfo.UP.down ||
		inputInfo.DOWN.down ||
		inputInfo.LEFT.down ||
		inputInfo.RIGHT.down;
}
...
void Controller::UpdateUpState(ControllerState& contState, ControllerInputInfo& inputInfo)
{
	...
	inputInfo.any.up = 
		...
		inputInfo.START.up ||
		inputInfo.BACK.up ||
		inputInfo.LSHOULDER.up ||
		inputInfo.RSHOULDER.up ||
		inputInfo.LTHUMB.up ||
		inputInfo.RTHUMB.up ||
		inputInfo.UP.up ||
		inputInfo.DOWN.up ||
