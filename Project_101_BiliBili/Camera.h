...
{
public:	//公開定数
	static constexpr  DirectX::XMFLOAT3 DEFAULT_POSITION = DirectX::XMFLOAT3(0.0f, 10.0f, -10.0f);	//デフォルトのカメラ位置
	...
	static constexpr float DEFAULT_FOV = DirectX::XM_PIDIV2;	//デフォルトの垂直視野角(45度)
